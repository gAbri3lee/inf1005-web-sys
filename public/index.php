    ...
    <section class="section-padding">
        <div class="container">
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-6 reveal-up">
                    <img
                        src="assets/images/SpaRoom.webp"
            ...
            <div class="row g-4">
                <div class="col-lg-4 reveal-up">
                    <article class="feature-card">
                        <img src="assets/images/Suite1.webp" alt="Refined suite with king bed, warm wood finishes and sea-facing terrace">
                        <h3>Horizon Suite</h3>
                        <p>
                ...
                <div class="col-lg-4 reveal-up">
                    <article class="feature-card">
                        <img src="assets/images/Suite2.webp" alt="Expansive resort exterior with pool, palm trees and sunset coastal backdrop">
                        <h3>Lagoon Villa</h3>
                        <p>
                ...
                <div class="col-lg-4 reveal-up">
                    <article class="feature-card">
                        <img src="assets/images/Suite3.webp" alt="Grand duplex-style luxury suite with staircase, chandelier and dramatic interior design">
            ...
            <div class="row g-4">
                <div class="col-lg-6 reveal-up">
                    <article class="dining-card">
                        <img src="assets/images/dining/RestaurantFieryBlaze.webp" alt="Warm upscale grill restaurant interior with live fire cooking and elegant evening ambience">
                ...
                <div class="col-lg-6 reveal-up">
                    <article class="dining-card">
                        <img src="assets/images/dining/RestaurantSunsetLagoon.webp" alt="Beachfront restaurant with ocean view, open-air seating and sunset dining atmosphere">
                        <div class="dining-card-body">
