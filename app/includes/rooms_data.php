...
function get_rooms_catalog(): array
{
    ...
    return [
        [
            ...
            'bed' => '1 King',
            'images' => [$img('Suite1.webp'), $img('HotelHomePage.webp'), $img('AboutUs.webp')],
        ...
        [
            ...
            'bed' => '1 King',
            'images' => [$img('Suite2.webp'), $img('SpaRoom.webp'), $img('Sustainability.webp')],
        ...
        [
            ...
            'bed' => '1 King + Sofa Bed',
            'images' => [$img('Suite3.webp'), $img('dining/RestaurantSunsetLagoon.webp'), $img('dining/Cafe.webp')],
        ...
        [
            ...
            'images' => [$img('AboutUsSpa.webp'), $img('Suite2.webp'), $img('Suite1.webp')],
        ...
        [
            ...
            'bed' => '1 Queen',
            'images' => [$img('parking_and_transport/parking1.webp'), $img('dining/RestaurantFieryBlaze.webp'), $img('DiscoverMore.webp')],
        ...
        [
            ...
            'bed' => '2 Singles',
            'images' => [$img('Suite1.webp'), $img('AboutUs.webp'), $img('Sustainability.webp')],
            'benefits' => ['Accessible-friendly layout', 'High-speed Wi‑Fi', 'Priority housekeeping'],
            'features' => ['Air-conditioned', 'Non-smoking', 'Connecting rooms (some rooms)', 'Smart TV'],
